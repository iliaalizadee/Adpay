...
public abstract class BaseSliderView {
    ...
    public BaseSliderView sub_name(String sub_name) {
        mSub_name = sub_name;
        return this;
    }

    public BaseSliderView rating(String rating) {
        mrating =rating;
        return this;
    }

    public BaseSliderView ratingView(String ratingView) {
        mratingView =ratingView;
        return this;
    }

    public BaseSliderView logo(String logo) {
        mlogo =logo;
        return this;
    }
