...
public class ProfileList implements Serializable {
    ...
    private String user_id,user_name,user_email,user_phone,user_image,user_total_video,user_youtube,user_instagram,user_code,total_point,total_followers,total_following,already_follow;
    private List<UserFollowList> userFollowerList;
    private List<UserFollowList> userFollowingList;

    public ProfileList(String user_id, String user_name, String user_email, String user_phone, String user_image, String user_total_video, String user_youtube, String user_instagram, String user_code, String total_point, String total_followers, String total_following, String already_follow, List<UserFollowList> userFollowerList, List<UserFollowList> userFollowingList) {
