...
public class AboutUsList implements Serializable {
    ...
    public int getTapsell_limit() {
        return tapsell_limit;
    }

    public void setTapsell_limit(int tapsell_limit) {
        this.tapsell_limit = tapsell_limit;
    }
    public int getAdmob_limit() {
        return admob_limit;
    }

    public void setAdmob_limit(int admob_limit) {
        this.admob_limit = admob_limit;
    }
    ...
    public boolean isWatermark_on_off() {
        return watermark_on_off;
    }

    public void setWatermark_on_off(boolean watermark_on_off) {
        this.watermark_on_off = watermark_on_off;
    }
}
