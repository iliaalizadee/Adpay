...
import com.example.videostatus.Util.DateHandler;
...
import com.example.videostatus.Activity.AllComment;
import com.example.videostatus.Activity.Login;
import com.example.videostatus.Activity.MainActivity;
import com.example.videostatus.Adapter.CommentAdapter;
import com.example.videostatus.Adapter.RelatedAdapter;
...
public class SCDetailFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(!manager.getLastDate().equals(DateHandler.gettime())){
            manager.setLastDate(DateHandler.gettime());
        }
        ...
        LinearLayout linearLayout_adView = view.findViewById(R.id.linearLayout_scd);
        ...
        if (method.personalization_ad) {
            method.showPersonalizedAds(linearLayout_adView, getActivity());
        } else {
            method.showNonPersonalizedAds(linearLayout_adView, getActivity());
        }
    ...
    public void getComment(Events.Comment comment) {
        videoLists.get(0).getCommentLists().add(0, new CommentList(comment.getUser_id(),
        ...
        if (commentAdapter != null) {
            ...
            String buttonTotal = getResources().getString(R.string.view_all) + " " + "(" + videoLists.get(0).getCommentLists().size() + ")";
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            for (int k = 0; k < jsonArray_comment.length(); k++) {
                                ...
                                arrayList.add(new CommentList(comment_user_id, comment_user_name, comment_user_image, comment_video_id, comment_text, comment_date));

                            }

                            videoLists.add(new SubCategoryList("", id, cat_id, video_title, video_url, video_layout, video_thumbnail_b, video_thumbnail_s, total_viewer, total_likes, category_name, already_like, user_id, user_name_single, user_image, already_follow, relatedLists, arrayList));
                        ...
                        if (videoLists.size() != 0) {
                            ...
                            commentAdapter = new CommentAdapter(getActivity(), videoLists);
                            ...
                            if (videoLists.size() != 0) {
                                ...
                                Picasso.get().load(videoLists.get(0).getVideo_thumbnail_b())
                                ...
                                imageView_like.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if (method.pref.getBoolean(method.pref_login, false)) {
                                            if (!videoLists.get(0).getUser_id().equals(user_id)) {
                                                if (Constant_Api.aboutUsList != null) {
                                ...
                                button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        Bundle bundle = new Bundle();
                                        bundle.putString("type", getResources().getString(R.string.related_video));
    ...
    private void checkLogin_following(final String user_id) {

        if (!videoLists.get(0).getUser_image().equals("")) {
            Picasso.get().load(videoLists.get(0).getUser_image())
                    .placeholder(R.drawable.user_profile).into(circleImageView);
        }
        if (videoLists.get(0).getUser_id().equals("0")) {
            textView_userName.setText(getResources().getString(R.string.admin));
        } else {
                ...
                switch (share_type) {
                    ...
                    case "whatsapp":
                        if (method.isAppInstalled_Whatsapp(getActivity())) {
                            ...
                            Toast.makeText(getActivity(), getResources().getString(R.string.please_install_whatsapp), Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case "facebook":
                        if (method.isAppInstalled_facebook(getActivity())) {
                            ...
                            Toast.makeText(getActivity(), getResources().getString(R.string.please_install_facebook), Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case "twitter":
                        if (method.isAppInstalled_twitter(getActivity())) {
                            ...
                            Toast.makeText(getActivity(), getResources().getString(R.string.please_install_twitter), Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case "instagram":
                        if (method.isAppInstalled_Instagram(getActivity())) {
                            ...
                            Toast.makeText(getActivity(), getResources().getString(R.string.please_install_instagram), Toast.LENGTH_SHORT).show();
                        }
                        break;
            ...
            if (Method.isDownload) {
                if (Method.allowPermitionExternalStorage) {
                    method.download(videoLists.get(0).getId(), videoLists.get(0).getCid(),
                            ...
                            videoLists.get(0).getVideo_thumbnail_b(),
    ...
    private void like_video(String profileId) {
        ...
        jsObj.addProperty("user_like",manager.getUserLike());
        params.put("data", API.toBase64(jsObj.toString()));
        client.post(Constant_Api.url, params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if (getActivity() != null) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (success.equals("1")) {
                                total_like = Integer.parseInt(videoLists.get(0).getTotal_likes());
                                total_like++;
                                manager.setUserLike(manager.getUserLike()+1);
                                videoLists.get(0).setTotal_likes(String.valueOf(total_like));
                                textView_like.setText(method.format(Double.parseDouble(videoLists.get(0).getTotal_likes())));
                                isString = "true";
                            ...
                            if (passId.equals(videoLists.get(0).getId())) {
                                if (type.equals("sub_category")) {
                                    Events.SubCatNotify subCatNotify = new Events.SubCatNotify("",
                                            String.valueOf(total_like), isString,
                                            "like", position);
                                ...
                                if (type.equals("related")) {
                                    Events.RelatedFragmentNotify relatedFragmentNotify = new Events.RelatedFragmentNotify("",
                                            String.valueOf(total_like), isString, "like", position);
                                ...
                                if (type.equals("user_profile")) {
                                    Events.UserProfile userProfile = new Events.UserProfile("",
                                            String.valueOf(total_like), isString,
                                            "like", position);
                                    GlobalBus.getBus().post(userProfile);
                                }
                            }

                            if (!db.checkId_Fav(videoLists.get(0).getId())) {
                                db.updateVideoLike(videoLists.get(0).getId(), String.valueOf(total_like), isString);
                            }
    ...
    private void video_view(String profileId) {
        ...
        jsObj.addProperty("user_view",manager.getUserView());
        params.put("data", API.toBase64(jsObj.toString()));
        client.post(Constant_Api.url, params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if (getActivity() != null) {
                    ...
                    try {
                        ...
                        total_view++;
                        manager.setUserView(manager.getUserView()+1);
                        ...
                        if (passId.equals(videoLists.get(0).getId())) {
                            ...
                            if (type.equals("user_profile")) {
                                Events.UserProfile userProfile = new Events.UserProfile(String.valueOf(total_view),
                                        "", "",
                                        "view", position);
                                GlobalBus.getBus().post(userProfile);
    ...
    private void downloadCount(String profileId) {
        ...
        jsObj.addProperty("video_id", videoLists.get(0).getId());
        jsObj.addProperty("user_id", profileId);
        jsObj.addProperty("user_dl",manager.getUserDl());
        params.put("data", API.toBase64(jsObj.toString()));
        client.post(Constant_Api.url, params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if (getActivity() != null) {
                    ...
                    Log.d("Response", new String(responseBody));
                    String res = new String(responseBody);
                    manager.setUserDl(manager.getUserDl()+1);
                    try {
                        JSONObject jsonObject = new JSONObject(res);
    ...
    private void updateData() {
        if (passId.equals(videoLists.get(0).getId())) {
            ...
            if (type.equals("user_profile")) {
                Events.UserProfile userProfile = new Events.UserProfile(videoLists.get(0).getTotal_viewer(),
                        videoLists.get(0).getTotal_likes(), videoLists.get(0).getAlready_like(),
                        "view_count", position);
                GlobalBus.getBus().post(userProfile);
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (success.equals("1")) {
                            ...
                            videoLists.get(0).getCommentLists().add(0, new CommentList(method.pref.getString(method.profileId, null),
                                    method.pref.getString(method.userName, null),
                                    userImage,
                                    videoLists.get(0).getId(), comment, getResources().getString(R.string.today)));
                            commentAdapter.notifyDataSetChanged();
                            String buttonTotal = getResources().getString(R.string.view_all) + " " + "(" + videoLists.get(0).getCommentLists().size() + ")";
                            button_all_comment.setText(buttonTotal);
                        }
