...
import com.example.videostatus.Adapter.StatusDetailAdapter;
...
public class DownloadStatusDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (method.personalization_ad) {
            method.showPersonalizedAds(linearLayout, DownloadStatusDetail.this);
        } else {
            method.showNonPersonalizedAds(linearLayout, DownloadStatusDetail.this);
        }
