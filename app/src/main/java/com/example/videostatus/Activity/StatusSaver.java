...
import com.example.videostatus.Adapter.VPAdapterSS;
...
public class StatusSaver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (method.personalization_ad) {
            method.showPersonalizedAds(linearLayout, StatusSaver.this);
        } else {
            method.showNonPersonalizedAds(linearLayout, StatusSaver.this);
        }
